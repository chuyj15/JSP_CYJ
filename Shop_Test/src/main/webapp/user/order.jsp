...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="oderDAO" class="shop.dao.OrderRepository"></jsp:useBean>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<body>   
	<% 
		...
		// 회원인 경우
		if (login ){
			orderList = oderDAO.list(loginId);
		...
		if (! login ){
			...
			if (orderList != null ){
				orderCount  = orderList.size();
				orderPhone = (String) session.getAttribute("phone");
			}
	...
	<div class="row m-0 mypage">
		...
		<div class="col-md-9 ms-sm-auto col-lg-10 p-0 m-0">
			...
			<div class="container shop m-auto mb-5">
					...
					<!-- 로그인 된 경우나, 올더폰 값이 있을 경우에는 주문내역목록을 가져옴.  -->
