...
<body>   
	<% 
		...
		boolean login = false;
		//.isEmpty() 메서드는 문자열이 비어 있는지 여부를 확인하는 메서드
			...
			<div class="container shop m-auto mb-5">
				<form action="update_pro.jsp" name="updateForm" method="post" >
					...
					<div class="d-flex justify-content-between mt-5 mb-5">
						...
						<input type="button" class="btn btn-lg btn-primary" value="수정" onclick="validation()"/>
					</div>	
	...
	<script>
		...
		//select, option 태그의 경우엔 value값을 지정해주면 그게 선택이 되어있는걸까..
